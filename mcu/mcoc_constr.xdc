...
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVCMOS33} [get_ports spis_irq_n]
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33} [get_ports spis_miso]
set_property -dict {PACKAGE_PIN W3 IOSTANDARD LVCMOS33} [get_ports spis_mosi]
set_property -dict {PACKAGE_PIN V3 IOSTANDARD LVCMOS33} [get_ports spis_ss]
set_property -dict {PACKAGE_PIN W5 IOSTANDARD LVCMOS33} [get_ports spis_sck]
...
set_property PULLTYPE PULLDOWN [get_ports spis_sck]
...
## SPIBUS unit
create_clock -period 27.000 -name spis_sck -waveform {0.000 13.500} [get_ports spis_sck]
set_false_path -from [get_clocks clk] -to [get_clocks spis_sck]
set_false_path -from [get_clocks spis_sck] -to [get_clocks clk]
